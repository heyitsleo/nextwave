...
export const metadata: Metadata = {
	metadataBase: new URL('https://watchwave.starnode.host'),
	title: 'WatchTV',
	description: 'Nextwave is a free streaming service for movies and TV shows.',
	keywords:
	...
	openGraph: {
		type: 'website',
		url: `https://watchwave.starnode.host`,
		images: [
			{
				url: '/Meta.png',
				alt: 'Logo',
